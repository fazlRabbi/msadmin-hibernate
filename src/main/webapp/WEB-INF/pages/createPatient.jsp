...
<div class="container">
    ...
    <form:form action="/patients/addPatient" class="centerContent" method="post" modelAttribute="patient">
        <div class="row">
            <label for="ssn">Ssn</label><br/>
            <input class="text-box single-line" id="ssn" name="ssn" type="text" value="${patient.ssn}"/>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <input class="text-box single-line" id="birthday" name="birthday" type="date" value="${patient.birthday}"/>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <input class="text-box single-line" id="zipCode" name="zipCode" maxlength="4" type="text" value="${patient.zipCode}"/>
        </div>
        <div class="row">
