...
<div class="container">
    <form:form action="/settings/updateSubject" class="centerContent" method="post" modelAttribute="subject">
        <input value="${subject.id}" id="id" name="id" type="hidden" />
        <div class="row">
            <label for="name">Name</label><br/>
            <input class="text-box single-line" id="name" name="name" type="text" value="${subject.name}"/>
        </div>
        <div class="row">
